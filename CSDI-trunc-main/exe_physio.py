...
from main_model import CSDI_Physio, Discriminator
...
parser.add_argument(
    "--nfold", type=int, default=0, help="for 5-fold test (valid value: [0-4])"
)
...
# Instantiate the generator (CSDI_Physio) model
